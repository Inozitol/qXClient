...
const QHash<QByteArray,IntFromString> map_word2int = {
    ...
    {R"(chat)",IntFromString::chat},
    {R"(groupchat)",IntFromString::groupchat},
    {R"(c)",IntFromString::c},
    {R"(to)",IntFromString::to},
    {R"(from)",IntFromString::from},
    {R"(get)",IntFromString::get},
    ...
    {R"(identity)",IntFromString::identity},
    {R"(feature)",IntFromString::feature},
    {R"(account)",IntFromString::account},
    {R"(auth)",IntFromString::auth},
    {R"(authz)",IntFromString::authz},
    {R"(automation)",IntFromString::automation},
    {R"(client)",IntFromString::client},
    {R"(collaboration)",IntFromString::collaboration},
    {R"(component)",IntFromString::component},
    {R"(conference)",IntFromString::conference},
    {R"(directory)",IntFromString::directory},
    {R"(gateway)",IntFromString::gateway},
    {R"(headline)",IntFromString::headline},
    {R"(hierarchy)",IntFromString::hierarchy},
    {R"(proxy)",IntFromString::proxy},
    {R"(pubsub)",IntFromString::pubsub},
    {R"(server)",IntFromString::server},
    {R"(store)",IntFromString::store},
    {R"(admin)",IntFromString::admin},
    {R"(anonymous)",IntFromString::anonymous},
    {R"(registered)",IntFromString::registered},
    {R"(cert)",IntFromString::cert},
    {R"(generic)",IntFromString::generic},
    {R"(ldap)",IntFromString::ldap},
    {R"(ntlm)",IntFromString::ntlm},
    {R"(pam)",IntFromString::radius},
    {R"(ephemeral)",IntFromString::ephemeral},
    {R"(command-list)",IntFromString::command_list},
    {R"(command-node)",IntFromString::command_node},
    {R"(rpc)",IntFromString::rpc},
    {R"(soap)",IntFromString::soap},
    {R"(translation)",IntFromString::translation},
    {R"(bot)",IntFromString::bot},
    {R"(console)",IntFromString::console},
    {R"(game)",IntFromString::game},
    {R"(handheld)",IntFromString::handheld},
    {R"(pc)",IntFromString::pc},
    {R"(phone)",IntFromString::phone},
    {R"(sms)",IntFromString::sms},
    {R"(tablet)",IntFromString::tablet},
    {R"(web)",IntFromString::web},
    {R"(whiteboard)",IntFromString::whiteboard},
    {R"(archive)",IntFromString::archive},
    {R"(c2s)",IntFromString::c2s},
    {R"(load)",IntFromString::load},
    {R"(log)",IntFromString::log},
    {R"(router)",IntFromString::router},
    {R"(s2s)",IntFromString::s2s},
    {R"(stats)",IntFromString::stats},
    {R"(irc)",IntFromString::irc},
    {R"(text)",IntFromString::text},
    {R"(chatroom)",IntFromString::chatroom},
    {R"(group)",IntFromString::group},
    {R"(user)",IntFromString::waitinglist},
    {R"(aim)",IntFromString::aim},
    {R"(facebook)",IntFromString::facebook},
    {R"(gadu-gadu)",IntFromString::gadu_gadu},
    {R"(http-ws)",IntFromString::http_ws},
    {R"(icq)",IntFromString::icq},
    {R"(lcs)",IntFromString::lcs},
    {R"(mrim)",IntFromString::mrim},
    {R"(msn)",IntFromString::msn},
    {R"(myspaceim)",IntFromString::myspaceim},
    {R"(ocs)",IntFromString::ocs},
    {R"(pstn)",IntFromString::pstn},
    {R"(qq)",IntFromString::qq},
    {R"(sametime)",IntFromString::sametime},
    {R"(simple)",IntFromString::simple},
    {R"(skype)",IntFromString::skype},
    {R"(smtp)",IntFromString::smtp},
    {R"(telegram)",IntFromString::telegram},
    {R"(tlen)",IntFromString::tlen},
    {R"(xfire)",IntFromString::xfire},
    {R"(xmpp)",IntFromString::xmpp},
    {R"(yahoo)",IntFromString::yahoo},
    {R"(newmail)",IntFromString::newmail},
    {R"(rss)",IntFromString::rss},
    {R"(weather)",IntFromString::weather},
    {R"(branch)",IntFromString::branch},
    {R"(leaf)",IntFromString::leaf},
    {R"(bytestreams)",IntFromString::bytestreams},
    {R"(collection)",IntFromString::collection},
    {R"(pep)",IntFromString::pep},
    {R"(service)",IntFromString::service},
    {R"(im)",IntFromString::im},
    {R"(berkeley)",IntFromString::berkeley},
    {R"(file)",IntFromString::file},
    {R"(mysql)",IntFromString::mysql},
    {R"(oracle)",IntFromString::oracle},
    {R"(postgres)",IntFromString::postgres},
    ...
    {R"(http://jabber.org/protocol/pubsub)",IntFromString::http_jabber_pubsub},
    ...
    {R"(http://jabber.org/protocol/pubsub#event)",IntFromString::http_jabber_pubsub_event},
    ...
    {R"(http://jabber.org/protocol/pubsub#manage-subscription)",IntFromString::http_jabber_pubsub_manage_subscription},
    ...
    {R"(http://jabber.org/protocol/pubsub#subscription-options)",IntFromString::http_jabber_pubsub_subscription_options},
    ...
    {R"(urn:ietf:params:xml:ns:xmpp-bind)",IntFromString::ns_xml_xmpp_bind},
    {R"(urn:ietf:params:xml:ns:xmpp-e2e)",IntFromString::ns_xml_xmpp_e2e},
    {R"(urn:ietf:params:xml:ns:xmpp-sasl)",IntFromString::ns_xml_xmpp_sasl},
    {R"(urn:ietf:params:xml:ns:xmpp-sasl#c2s)",IntFromString::ns_xml_xmpp_sasl_c2s},
    {R"(urn:ietf:params:xml:ns:xmpp-sasl#s2s)",IntFromString::ns_xml_xmpp_sasl_s2s},
    {R"(urn:ietf:params:xml:ns:xmpp-session)",IntFromString::ns_xml_xmpp_session},
    {R"(urn:ietf:params:xml:ns:xmpp-stanzas)",IntFromString::ns_xml_xmpp_stanzas},
    {R"(urn:ietf:params:xml:ns:xmpp-streams)",IntFromString::ns_xml_xmpp_streams},
    {R"(urn:ietf:params:xml:ns:xmpp-tls)",IntFromString::ns_xml_xmpp_tls},
    {R"(urn:ietf:params:xml:ns:xmpp-tls#c2s)",IntFromString::ns_xml_xmpp_tls_c2s},
    {R"(urn:ietf:params:xml:ns:xmpp-tls#s2s)",IntFromString::ns_xml_xmpp_tls_s2s},
    ...
    {R"(urn:xmpp:avatar:metadata+notify)",IntFromString::ns_xmpp_avatar_metadata_notify},
...
QByteArray int2word(IntFromString word){
    // I really hate this, but too lazy to fix it
    return map_word2int.keys(word).at(0);
}
